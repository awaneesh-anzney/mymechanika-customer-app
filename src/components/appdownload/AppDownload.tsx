          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-4 items-center max-w-6xl mx-auto">
            <div className="text-center lg:text-left animate-slide-up lg:pr-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                Car Service at Your <span className="bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">Fingertips</span>
              </h2>
              <p className="text-muted-foreground mb-8 max-w-lg mx-auto lg:mx-0">
                Book services, track repairs, manage your cars, and get exclusive app-only discounts. Everything you need for hassle-free car maintenance.
              </p>
                  ...
                  <div className="w-full h-full rounded-[2.5rem] bg-card border border-border overflow-hidden flex flex-col">
                    ...
                    <div className="flex-1 p-4 space-y-4">
                      ...
                      <div className="space-y-2">
                        {["Book Service", "Track Repair", "My Cars", "Offers"].map((item, i) => (
