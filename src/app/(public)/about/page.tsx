...
const Page = () => {
  ...
  const activeT = mounted ? t : i18n.getFixedT('en', 'about');

  const team = [
    {
      name: activeT("team.members.rajesh.name"),
      role: activeT("team.members.rajesh.role"),
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face",
    },
    {
      name: activeT("team.members.priya.name"),
      role: activeT("team.members.priya.role"),
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=300&h=300&fit=crop&crop=face",
    },
    {
      name: activeT("team.members.amit.name"),
      role: activeT("team.members.amit.role"),
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face",
    },
    {
      name: activeT("team.members.sneha.name"),
      role: activeT("team.members.sneha.role"),
  ...
  const values = [
    {
      icon: Shield,
      title: activeT("values.items.trust.title"),
      description: activeT("values.items.trust.description"),
    },
    {
      icon: Users,
      title: activeT("values.items.customer.title"),
      description: activeT("values.items.customer.description"),
    },
    {
      icon: Target,
      title: activeT("values.items.excellence.title"),
      description: activeT("values.items.excellence.description"),
    },
    {
      icon: Award,
      title: activeT("values.items.quality.title"),
      description: activeT("values.items.quality.description"),
    },
  ];

  const milestones = [
    { year: "2018", event: activeT("timeline.milestones.2018") },
    { year: "2019", event: activeT("timeline.milestones.2019") },
    { year: "2020", event: activeT("timeline.milestones.2020") },
    { year: "2021", event: activeT("timeline.milestones.2021") },
    { year: "2022", event: activeT("timeline.milestones.2022") },
    { year: "2023", event: activeT("timeline.milestones.2023") },
  ];
  ...
  return (
    <div className="flex flex-col gap-12 lg:gap-24 py-12 lg:py-20">
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 animate-fade-in">
            {[
              { value: "2M+", label: activeT("story.stats.cars") },
              { value: "50+", label: activeT("story.stats.cities") },
              { value: "1000+", label: activeT("story.stats.centers") },
              { value: "4.8★", label: activeT("story.stats.rating") },
            ].map((stat, index) => (
              <div
                key={index}
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            {activeT("values.title")}
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            {activeT("values.subtitle")}
          </p>
        </div>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            {activeT("timeline.title")}
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            {activeT("timeline.subtitle")}
          </p>
        </div>
